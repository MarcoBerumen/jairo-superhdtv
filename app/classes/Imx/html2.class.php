...
class html2 extends sidebar2
{
    ...
    static public    function head2($title, $styles = [])
    {
        ...
        echo  $latte->renderToString('../app/templates/html/head2.latte', $params);
        return "";
    ...
    static public function header2($items)
    {
        $latte = new Latte\Engine;
        ...
        echo  $latte->renderToString('../app/templates/html/header2.latte', $params);
        return ;
    ...
    {
        $latte = new Latte\Engine;
        echo  $latte->renderToString('../app/templates/html/scripts.latte',['scripts'=>$extra]);

        return "";

    }

    static public function scripts2($charts = false, $extra = "")
    {
        $latte = new Latte\Engine;
        echo  $latte->renderToString('../app/templates/html/scripts2.latte',['scripts'=>$extra]);
...
//        print_r($breadcrumbs);
        $latte = new Latte\Engine;
         echo  $latte->renderToString('../app/templates/html/begincontent.latte',["links"=>$breadcrumbs]);

    }
    static public function endContent()
    {
            $latte = new Latte\Engine;
         echo  $latte->renderToString('../app/templates/html/endcontent.latte');
         return "";
    ...
    <div class="theme-panel-content">
        ...
        <ul class="theme-list clearfix">
            <li><a href="javascript:;" class="bg-red" data-theme="red"
                    ...
                    data-bs-toggle="tooltip" data-trigger="hover" data-container="body" data-title="Red">&nbsp;</a>
            </li>
            <li><a href="javascript:;" class="bg-pink" data-theme="pink"
                    ...
                    data-bs-toggle="tooltip" data-trigger="hover" data-container="body"
            ...
            <li class="active"><a href="javascript:;" class="bg-teal" data-theme="default" data-theme-file=""
                    data-click="theme-selector" data-bs-toggle="tooltip" data-trigger="hover" data-container="body"
