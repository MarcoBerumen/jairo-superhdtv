...
$tabla = $tabla . " <button class=\"btn btn-primary\" onclick=\"window.location.href='/back-office/customers/new'\"><i class='fa fa-plus'></i>&nbsp;Add </button>";

echo  $latte->renderToString('../app/templates/panel.latte', ["title" => "Customers", "body" => $tabla]);
    ...
    var handleDataTableDefault = function() {
        ...
        if ($('#customersTable').length !== 0) {
            window.table = $('#customersTable').DataTable({
                ...
                ajax: '/api/back-office/customers',
                "columnDefs": [{
                    "targets": -1,
                    "data": null,
                        ...
                        return `
                            <div class="btn-group m-r-5 m-b-5">
            								...
            								<div class="dropdown-menu dropdown-menu-right">
            									<a href="/back-office/customers/` + data[0] + `" class="dropdown-item">Edit</a>
            									<a href="/back-office/customers/` + data[0] + `/delete" class="dropdown-item">Delete</a>
            								</div>
            							</div>
                            `
                    }
