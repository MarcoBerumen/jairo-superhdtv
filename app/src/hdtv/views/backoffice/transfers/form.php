...
html::beginContent([
    ['text' => "Back Office"],
    ['text' => "Inventory Transfer", "link" => "/back-office/transfers"],
    ['text' => $formTitle, "link" => "/back-office/transfers/$id"],
]);
...
$params = [
    ...
    ['name' => 'date', 'value' => Imx\utils::sql2date($formdata['date'] ?? date('Y-m-d')), "locale" => "en", 'format' => 'm/d/Y', 'label' => 'Date', 'required' => 'true', 'type' => 'date'],
        [
            'name' => 'origin_id', 'value' => $formdata['origin_id'] ?? $store,
            'label' => 'Origin Store', 'required' => 'true', 'type' => "select", "ajax" => "/api/sel2/stores/"
        ],
        [
            'name' => 'destination_id', 'value' => $formdata['destination_id'] ?? "",
            'label' => 'Destination Store', 'required' => 'true', 'type' => "select", "ajax" => "/api/sel2/stores_destination/"
        ],

        ['name' => 'total', 'value' => $formdata['total'] ?? "0", 'label' => 'Total Cost',  'required' => 'true', 'type' => 'rnumeric'],
...
echo  $latte->renderToString('../app/templates/panel.latte', ["title" => "$formTitle Inventory Transfer", "body" => $form]);
...
<input type="button" class="btn btn-danger" onclick="window.location.href=\'/back-office/transfers\'" value="Back">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <textarea id="validationresult" rows="20" class="form-control"></textarea>
                </div>
    ...
    <script>
        ...
        async function  validateSerials(){
            ...
            serials.forEach(async (serial) => {
                ...
                let response = await axios.get("/api/items/"+serial+"?store="+$('#origin_id').val());
                // avoid duplicating
        ...
        function validaForm() {
            ...
            Imx.validaForm('/api/back-office/transfers/<?php echo $id; ?>', true, ['x_items'], dt1);
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            from transactions  where transaction_type ='Transfer' and reference_id =  '$id' ";
            ...
            */
            ...
            $(document).ready(function() {
                ...
                $('#x_itemsmodal').on('show.bs.modal', function() {
                    ...
                    //     ajax: {
                    //         url:  function() {
                    //             return "/api/sel2/serials?store=" +  $('#origin_id').val()
                    //                 +'&grade='+$('#grade_id').val()
