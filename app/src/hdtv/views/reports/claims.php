...
$html = '
<input type="button" class="btn btn-primary" onclick="validateForm();" value="Get Claims">
<br>
<br>
...
echo  $latte->renderToString('../app/templates/panel.latte', ["title" => "Claims Report", "body" => $form . $html]);
?>
...
`);
            Imx.validaForm('/api/reports/claims', false, [], "", "", "", false);
