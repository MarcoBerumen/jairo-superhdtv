...
$tabla = $tabla . " <button class=\"btn btn-primary\" onclick=\"window.location.href='/catalogs/providers/new'\"><i class='fa fa-plus'></i>&nbsp;Add </button>";

echo  $latte->renderToString('../app/templates/panel.latte', ["title" => "Providers", "body" => $tabla]);
                        ...
                        return `
                            <div class="btn-group m-r-5 m-b-5">
            								...
            								<div class="dropdown-menu dropdown-menu-right">
            									<a href="/catalogs/providers/` + data[0] + `" class="dropdown-item">Edit</a>
            									<a href="/catalogs/providers/` + data[0] + `/delete" class="dropdown-item">Delete</a>
            								</div>
            							</div>
                            `
                    }
