...
$tabla = $tabla . " <button class=\"btn btn-primary\" onclick=\"window.location.href='/catalogs/payment-methods/new'\"><i class='fa fa-plus'></i>&nbsp;Add </button>";

echo  $latte->renderToString('../app/templates/panel.latte', ["title" => "Payment methods", "body" => $tabla]);
...
<script>
    var handleDataTableDefault = function() {
        ...
        if ($('#payment_methodsTable').length !== 0) {
            $('#payment_methodsTable').DataTable({
                ...
                ajax: '/api/catalogs/payment-methods',
                "columnDefs": [{
                    "targets": -1,
                    "data": null,
                        ...
                        return `
                            <div class="btn-group m-r-5 m-b-5">
            								...
            								<div class="dropdown-menu dropdown-menu-right">
            									<a href="/catalogs/payment-methods/` + data[0] + `" class="dropdown-item">Edit</a>
            									<a href="/catalogs/payment-methods/` + data[0] + `/delete" class="dropdown-item">Delete</a>
            								</div>
            							</div>
                            `
                    }
