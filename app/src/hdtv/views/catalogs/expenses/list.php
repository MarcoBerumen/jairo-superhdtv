...
$tabla = $tabla . " <button class=\"btn btn-primary\" onclick=\"window.location.href='/catalogs/expenses-types/new'\"><i class='fa fa-plus'></i>&nbsp;Add </button>";

echo  $latte->renderToString('../app/templates/panel.latte', ["title" => "Expenses types", "body" => $tabla]);
...
<script>
    var handleDataTableDefault = function() {
        ...
        if ($('#expenses-typesTable').length !== 0) {
            $('#expenses-typesTable').DataTable({
                ...
                ajax: '/api/catalogs/expenses-types',
                "columnDefs": [{
                    "targets": -1,
                    "data": null,
                        ...
                        return `
                            <div class="btn-group m-r-5 m-b-5">
            								...
            								<div class="dropdown-menu dropdown-menu-right">
            									<a href="/catalogs/expenses-types/` + data[0] + `" class="dropdown-item">Edit</a>
            								</div>
            							</div>
                            `
                    }
