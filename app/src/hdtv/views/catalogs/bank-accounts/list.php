...
$tabla = $tabla . " <button class=\"btn btn-primary\" onclick=\"window.location.href='/catalogs/bank-accounts/new'\"><i class='fa fa-plus'></i>&nbsp;Add </button>";

echo  $latte->renderToString('../app/templates/panel.latte', ["title" => "Bank accounts", "body" => $tabla]);
...
<script>
    var handleDataTableDefault = function() {
        ...
        if ($('#bank_accountsTable').length !== 0) {
            $('#bank_accountsTable').DataTable({
                ...
                ajax: '/api/catalogs/bank-accounts',
                "columnDefs": [{
                    "targets": -1,
                    "data": null,
                        ...
                        return `
                            <div class="btn-group m-r-5 m-b-5">
            								...
            								<div class="dropdown-menu dropdown-menu-right">
            									<a href="/catalogs/bank-accounts/` + data[0] + `" class="dropdown-item">Edit</a>
            									<a href="/catalogs/bank-accounts/` + data[0] + `/delete" class="dropdown-item">Delete</a>
            								</div>
            							</div>
                            `
                    }
